...
<div id="apDiv8">
  ...
  <div id="featured" > 
    ...
    <li class="ui-tabs-nav-item" id="nav-fragment-4"><a href="#fragment-4"><img src="images/image4-small.jpg" alt="" /><span>Sentarse Correctamente</span></a>
    </li> 
  ...
  <div id="usuario">
    <table width="315" border="0" align="center">
      <tr>
        ...
        <input type="submit" name="button" id="button" value="Salir"/></a></td>
      </tr>
    </table>
    <?php
