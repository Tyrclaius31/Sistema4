...
<div id="contenedorgeneral">
  ...
  <div id="cuerpoleft">
    ...
    <h3><center> Camiones</center></h3>
      <ul>
                        <li><a href="pages/camiones/camion.registro.php" title="Registrar Nuevo Camión">- Registrar</a></li>
                        ...
                        <li><a href="pages/camiones/camion.modasignar.php" title="Modificar Asignación">- Mod. Asignación</a></li>
                        <li><a href="pages/camiones/camion.verasignar.php" title="Ver Asignaciones Actuales">- Ver Asignaciones</a></li>
                        <li><a href="#" title="">______________</a></li>
    ...
    <h3><center>Mantención</center></h3>
      <ul>
                        <li><a href="pages/camiones/mantencion.registro.php" title="Registrar Nueva Mantención">- Ingresar Mant.</a></li>
                        <li><a href="pages/camiones/mantencion.listar.php" title="Listar Datos de Mantención">- Listar Mant.</a></li>
                        <li><a href="pages/camiones/mantencion.modificar.php" title="Modificar Datos de Mantención">- Modificar Mant.</a></li>
      </ul>
