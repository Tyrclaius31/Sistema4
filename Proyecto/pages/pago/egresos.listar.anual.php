...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Informe de Egresos Anuales</strong></h3>
    <div id="tira">
  ...
  <tr><td width='65'>FECHA</td><td width='85'>N° BOL./FACT.</td><td width='130'>RAZÓN</td><td width='330'>DESCRIPCIÓN</td><td width='60'>VALOR</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from egresos where Ano=".$_POST[ano]." order by Mes asc";
...
?>
    ...
    <hr>
<?
	$sql="select sum(Costo) from egresos where Ano=".$_POST[ano];
		$respuesta=mysql_query($sql,$conexion);
		
		echo "<h4><table width='670' border='0' align='center'>";
		while($row=mysql_fetch_array($respuesta))
		{
			echo "<tr><td width='70'> </td><td width='130'> </td><td width='400'>Gasto Total Año</td><td width='70'>$ ".$row['sum(Costo)']."									  			</td></tr>";
		} 
		echo "<h4></table>";
