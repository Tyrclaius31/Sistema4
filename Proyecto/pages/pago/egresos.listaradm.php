...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Informe de Egresos por Mes</strong></h3>
    <div id="tira">
...
<?php
  ...
  <tr><td width='65'>FECHA</td><td width='85'>N° BOL./FACT.</td><td width='100'>RAZÓN</td><td width='250'>DESCRIPCIÓN</td><td width='60'>VALOR</td><td width='60'>F. MOD.</td><td width='50'>USUARIO</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from egresos where Mes=".$_POST[mes]." and Ano=".$_POST[ano]." order by Dia asc";
		...
		{
			echo "<tr><td width='65'>".$row["Ano"]."-".$row["Mes"]."-".$row["Dia"]."</td><td width='85'>".$row["N_Boleta"]."</td><td width='100'>".$row["Razon"]."</td><td width='250'>".$row["Descripcion"]."</td><td width='60'>".$row["Costo"]."</td><td width='60'>".$row["Fecha_Modificacion"]."</td><td width='50'>".$row["Modificacion_Usuario"]."</td></tr>";
		} 
		echo "<h6></table>";
...
?>
    ...
    <hr>
<?
	$sql="select sum(Costo) from egresos where Mes=".$_POST[mes]." and Ano=".$_POST[ano];
		$respuesta=mysql_query($sql,$conexion);
