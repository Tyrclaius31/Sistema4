  ...
  <div id="cuerpoleft">
    ...
    <form id="form1" name="form1" method="post" action="">
      <table width="571" border="0" align="center">
        <tr>
          <td colspan="4" align="center"><h3>Registro de Egresos Con Iva</h3></td>
          </tr>
        <tr>
...
?>
	...
	if($_POST[button]=="Registrar Egreso")
	{
		...
		$sql="insert into egresos_iva values('".$p_N_Boleta."','".$p_Fecha_Ingreso."','".$p_Dia."','".$p_Mes."','".$p_Ano."','".				     	$p_Razon."','".$p_Descripcion."','".$p_Valor_Neto."','".$p_Iva."','".$p_Valor_Iva."','".$p_Costo."','".$p_Modificacion_Usuario    	."','".$p_Fecha_Modificacion."')";
