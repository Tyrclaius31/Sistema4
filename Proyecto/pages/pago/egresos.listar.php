...
<option selected="selected">2010</option>
  ...
  <tr><td width='65'>FECHA</td><td width='85'>N° BOL./FACT.</td><td width='130'>RAZÓN</td><td width='330'>DESCRIPCIÓN</td><td width='60'>VALOR</td></tr></table></font></b>";
	echo "<hr>";
		...
		{
			echo "<tr><td width='65'>".$row["Ano"]."-".$row["Mes"]."-".$row["Dia"]."</td><td width='85'>".$row["N_Boleta"]."</td><td width='130'>".$row["Razon"]."</td><td width='330'>".$row["Descripcion"]."</td><td width='60'>".$row["Costo"]."</td></tr>";
		} 
		echo "<h6></table>";
