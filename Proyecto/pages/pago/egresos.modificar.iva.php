...
<div id="contenedorgeneral">
  ...
  <form id="form1" name="form1" method="post" action="">
    <h3 align="center"><strong> Modificar Datos de Egresos</strong> Con Iva</h3>
	...
	$conexion=Conectarse();
	  	...
	  	$result=mysql_query("select * from egresos_iva");
	...
	{
		$sql="select * from egresos_iva where N_Boleta =".$_POST['boleta'];
    ...
    <table width="574" border="0" align="center">
      ...
      <tr>
        <td>Fecha Ingreso</td>
        <td><script> var costo = new LiveValidation('costo'); costo.add( Validate.Numericality, { onlyInteger: true} ); costo.add(Validate.Presence);</script>

          <input name="textfield3" type="text" disabled id="textfield3" value="<? echo $registro[1];?>" size="15" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td>Valor Neto</td>
        <td><label>
          <input name="textfield" type="text" disabled="disabled" id="textfield" value="<? echo $registro[7];?>" size="15" />
        </label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>Iva 19%</td>
        <td><label>
          <input name="textfield2" type="text" disabled="disabled" id="textfield2" value="<? echo $registro[9];?>" size="15" />
        </label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td><input name="costo" type="text" id="costo" value="<? echo $registro[10];?>" size="15" maxlength="25"/>
	...
	$sql="select * from usuarios where Clave_Permiso =".$_POST['clave'];
		...
		if($_POST[razon]=="" or $_POST[descripcion]=="" or $_POST[costo]=="")
		{
			...
			if($_POST[clave]=="")
			{
				...
				$sql="update egresos_iva set Razon='".$_POST[razon]."',Descripcion='".$_POST[descripcion]."',Valor_Neto='".$neto.       			"',Valor_Iva='".$iva."',Costo='".$_POST[costo]."',Modificacion_Usuario='".$_POST[nick]."',Fecha_Modificacion='".$_POST   				[modificar]."' WHERE N_Boleta='".$_POST[boleta1]."' ";
			
				$respuesta=mysql_query($sql,$conexion);
				echo '<script>alert("La Modificación se Realizo con éxito.");</script>';
		}
		}
		}else{
