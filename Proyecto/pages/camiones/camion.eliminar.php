	...
	<!-- modal content -->
		<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
                ...
                <p align="justify">Primero seleccionamos el camión y presionamos el botón <b>"Buscar"</b>. Luego el sistema nos arroja la información del camión junto con un cuadro de texto, en donde debemos colocar el motivo de la eliminación.<br><br>
  ...
  <div id="cuerpoleft">
    ...
    <table width="560" border="0" align="center">
      <tr>
        ...
        <td width="173"><label>
          <input name="marca" type="text" disabled="disabled" id="marca" value="<? echo $registro[1];?>" size="25"/>
        </label></td>
        <td width="76">Modelo</td>
        <td width="177"><label>
          <input name="modelo" type="text" disabled="disabled" id="modelo" value="<? echo $registro[2];?>" size="25"/>
        </label></td>
      </tr>
      <tr>
        <td>Patente</td>
        <td><label>
          <input name="ano" type="text" disabled="disabled" id="ano" value="<? echo $registro[9];?>" size="25" maxlength="100"/>
        </label></td>
        <td>Nombre</td>
        <td><input name="nombre" type="text" disabled="disabled" id="nombre" value="<? echo $registro[10];?>" size="25" maxlength="25"/></td>
      </tr>
      <tr>
        <td>Fecha Ingreso</td>
        <td><input name="textfield5" type="text" disabled="disabled" id="textfield5" value="<? echo $registro[12];?>" size="25" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <input type="hidden" name="salida" id="salida" value="<? echo date('Y-m-d'); ?>"/></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
...
<?php
	...
	$sql="select * from usuarios where Clave_Permiso =".$_POST['clave'];
		...
		if($_POST[motivo]=="")
		{
			...
			$sql="update camiones set Estado='".$_POST[estado]."',Motivo='".$_POST[motivo]."',Eliminar_Usuario='".$_POST[nick].   		   			"',Fecha_Salida='".$_POST[salida]."' WHERE Id='".$_POST[id]."' ";
