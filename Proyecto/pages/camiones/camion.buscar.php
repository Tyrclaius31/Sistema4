        ...
        <div id="contenido">
          <form id="form1" name="form1" method="post" action="">
            ...
            <p align="center"><strong>Seleccione Camión</strong>
              ...
              <label>
                <input type="submit" name="button2" id="button2" value="Buscar" /><br>
              </label>
            </p>
            <?php
              if($_POST['button2']=="Buscar"){
                ...
                <table width="560" border="0" align="center">
                  <tr>
                    ...
                    <td width="173"><label>
                      <input name="nombre1" type="text" disabled id="nombre1" value="<?php echo $registro[1];?>" size="25"/>
                    </label></td>
                    <td width="76">Modelo</td>
                    <td width="177"><label>
                      <input name="rut" type="text" disabled id="rut" value="<?php echo $registro[2];?>" size="25"/>
                    </label></td>
                  </tr>
                  <tr>
                    <td>Año</td>
                    <td><label>
                      <input name="direccion" type="text" disabled id="direccion" value="<?php echo $registro[3];?>" size="25" maxlength="100"/>
                    </label></td>
                    <td>Tipo Camión</td>
                    <td><label>
                      <input name="textfield4" type="text" disabled="disabled" id="textfield4" value="<?php echo $registro[4];?>" size="25" />
                    </label></td>
                  </tr>
                  <tr>
                    <td>Tipo Cabina</td>
                    <td><input name="telefono" type="text" disabled id="telefono" value="<?php echo $registro[5];?>" size="25" maxlength="25"/></td>
                    <td>Color</td>
                    <td><input name="zona" type="text" disabled id="zona" value="<?php echo $registro[6];?>" size="25" /></td>
                  </tr>
                  <tr>
                    <td>Kilometraje</td>
                    <td><input name="textfield" type="text" disabled id="textfield" value="<?php echo $registro[7];?>" size="25" /></td>
                    <td>Tipo Motor</td>
                    <td><input name="textfield2" type="text" disabled id="textfield2" value="<?php echo $registro[8];?>" size="25" /></td>
                  </tr>
                  <tr>
                    <td>Patente</td>
                    <td><input name="cargo" type="text" disabled id="cargo" value="<?php echo $registro[9];?>" size="25" /></td>
                    <td>Nombre</td>
                    <td><input name="telefono2" type="text" disabled id="telefono2" value="<?php echo $registro[10];?>" size="25" maxlength="25"/></td>
                  </tr>
                  <tr>
                    <td>Comentario</td>
                    <td colspan="3"><input name="textfield3" type="text" disabled id="textfield3" value="<?php echo $registro[11];?>" size="70" /></td>
                    </tr>
                  <tr>
                    <td>Fecha Ingreso</td>
                    <td><label>
                      <input name="textfield5" type="text" disabled="disabled" id="textfield5" value="<?php echo $registro[12];?>" size="25" />
                    </label></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
