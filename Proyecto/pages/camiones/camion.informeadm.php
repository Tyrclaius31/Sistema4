...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Informe de Camiones</h3>
                 <p align="justify">Esta opción permite mostrar un listado de los camiones pertenecientes a la empresa.<br><br> Además se puede contemplar la fecha de la última modificación que se le hizo al registro, como también el usuario que la hizo.</p>                                 <p align="center"><h5><img src="../../images/log.png"/></h5></p>   
...
<div id="contenedorgeneral">
  ...
  <tr><td width='80'>PATENTE</td><td width='80'>MARCA</td><td width='60'>MODELO</td><td width='40'>AÑO</td><td width='110'>TIPO CAMIÓN</td><td width='65'>COLOR</td><td width='60'>NOMBRE</td><td width='60'>F. INGRESO</td><td width='60'>ULT. MODIF.</td><td width='60'>USUARIO</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from camiones where Estado='ACTIVO'";
		$respuesta=mysql_query($sql,$conexion);
		while($row=mysql_fetch_array($respuesta))
		{
			echo "<table width='680' border='0' align='center'><tr><td width='80'>".$row["Traccion"]."</td><td width='80'>".$row["Marca"]."</td><td width='60'>".$row["Modelo"]."</td><td width='40'>".$row["Ano"]."</td><td width='110'>".$row["Tipo"]."</td><td width='65'>".$row["Color"]."</td><td width='60'>".$row["Nombre"]."</td><td width='60'>".$row["Fecha_Ingreso"]."</td><td width='60'>".$row["Fecha_Modificacion"]."</td><td width='60'>".$row["Modificacion_Usuario"]."</td></tr></table>";
		}
	//}
