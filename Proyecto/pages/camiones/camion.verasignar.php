...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Lista de Asignaciones Activas</h3>
                 <p align="justify">Esta opción permite mostrar un listado de de las asignaciones realizadas y que están activas.<br><br> Aquí aparece la relación entre Hombre - Camión, con sus especificaciones.</p>       
...
<div id="contenedorgeneral">
  ...
  <div id="cuerpoleft">
    ...
    <div id="contenido">
    <h3><center>Informe de Asignaciones</center></h3>
  ...
  <tr><td width='180'>NOM. TRABAJADOR</td><td width='80'>RUT</td><td width='100'>NOM. CAMION</td><td width='70'>PATENTE</td><td width='70'>MARCA</td><td width='80'>F. ASIGNACION</td><td width='70'>F. MODIFIC.</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from asignacion_camiones where Estado='ACTIVO'";
		$respuesta=mysql_query($sql,$conexion);
		
		echo "<table width='650' border='0' align='center'>";
		while($row=mysql_fetch_array($respuesta))
		{
			echo "<tr><td width='180'>".$row["Nombre_Tra"]."</td><td width='80'>".$row["Rut_Tra"]."</td><td width='100'>".$row["Nombre_Ca"]."</td> <td width='70'>".$row["Patente_Ca"]."</td><td width='70'>".$row["Marca_Ca"]."</td><td width='80'>".$row["Fecha_Asignacion"]."</td><td width='70'>".$row["Fecha_Modificacion"]."</td></tr>";
		}
		echo "</table>";
	//}
