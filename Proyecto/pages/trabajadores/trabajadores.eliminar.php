	...
	<!-- modal content -->
		<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Eliminar Registro de Trabajadores</h3>
                 <p align="justify">Esta opción nos permite eliminar a un trabajador del sistema despues de haber sido despedido de la empresa.</p><br>
...
<div id="contenedorgeneral">
  ...
  <div id="cuerpoleft">
    ...
    <h3 align="center"><strong> Eliminar Trabajador</strong></h3>
	...
	{
		$sql="select * from n_operador where Rut_Operador =".$_POST['nombre']." and Estado='CONTRATADO' and Cargo_Operador='Chofer'";
    ...
    <table width="630" border="0" align="center">
      ...
      <tr>
        ...
        <td>Cargo</td>
        <td><input name="cargo" type="text" disabled id="cargo" value="<? echo $registro[6];?>" size="25" /></td>
      </tr>
    </table>
    <table width="630" border="0" align="center">
      <tr>
        <td width="101" height="21">Estado</td>
        <td width="215"><input name="textfield3" type="text" disabled id="textfield3" value="<? echo $registro[10];?>" size="25"></td>
        <td width="121">Fecha Ingreso</td>
        <td width="175"><input name="horario" type="text" disabled id="horario" value="<? echo $registro[9];?>" size="25"></td>
        </tr>
    </table>
    <table width="382" border="0" align="center">
      ...
      <tr>
        ...
        <td colspan="2"><label>
          <textarea name="motivo" id="motivo" cols="45" rows="3"></textarea>
...
<?php
	...
	if($_POST[button]=="Eliminar")
	{
		...
		echo '<script>alert("Al Eliminar un Trabajdor del SCG se denota que éste a sido Despedido por la Empresa.");</script>';
