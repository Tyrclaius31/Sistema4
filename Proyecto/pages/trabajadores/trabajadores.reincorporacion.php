	...
	<!-- modal content -->
		<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Reincorporación de Trabajadores</h3>
                 <p align="justify">Esta opción permite reintegrar a la empresa a los trabajadores que fueron despedidos anteriormente.</p><br>
...
<div id="contenedorgeneral">
 ...
 <div id="usuario">
  ...
  <div id="cuerpoleft">
    ...
    <h3 align="center"><strong> Reincorporar Trabajador</strong></h3>
	...
	$fecha1= mktime(0,0,0,date("m"),date("d"),date("Y"));
	  	...
	  	$result=mysql_query("select * from n_operador where Estado='DESPEDIDO' and Cargo_Operador='Chofer'");
	...
	{
		$sql="select * from n_operador where Rut_Operador =".$_POST['nombre']." and Estado='DESPEDIDO' and Cargo_Operador='Chofer'";
    ...
    <table width="630" border="0" align="center">
      ...
      <tr>
        ...
        <td>Cargo</td>
        <td><input name="cargo" type="text" id="cargo" value="<? echo $registro[6];?>" size="25" /></td>
      </tr>
    </table>
    <table width="630" border="0" align="center">
      <tr>
        <td width="101" height="21">Estado</td>
        <td width="215"><input name="textfield3" type="text" id="textfield3" value="<? echo $registro[10];?>" size="25"></td>
        <td width="121">Fecha Ingreso</td>
        <td width="175"><input name="horario" type="text" id="horario" value="<? echo $registro[9];?>" size="25"></td>
        </tr>
    </table>
...
<?php
	...
	$sql="select * from usuarios where Clave_Permiso =".$_POST['Clave'];
		...
		if($_POST[checkbox]=="")
		{
			echo '<script>alert("No puede Eliminar si no Acepta la Reincorporación");</script>';
		}else{
			if($_POST[clave]=="")
			{
