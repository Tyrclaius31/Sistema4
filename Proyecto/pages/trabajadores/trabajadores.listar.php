...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Listar Registros de Trabajadores</h3>
                 <p align="justify">Esta opción permite mostrar un listado de los trabajadores de la empresa. Aquí sólo se mostrarán los Trabajadores que sean Choferes y que tengan a cargo un Camión.<br></p>      
...
<font size="1">
  ...
  <tr><td width='60'>RUT</td><td width='120'>NOMBRE</td><td width='60'>TELEFONO</td><td width='220'>DIRECCION</td><td width='100'>F. NACIM.</td><td width='70'>CARGO</td><td width='70'>LICENCIA</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from n_operador where Estado='CONTRATADO' and Cargo_Operador='Chofer'";
		$respuesta=mysql_query($sql,$conexion);
		while($row=mysql_fetch_array($respuesta))
		{
			echo "<table width='700' border='0' align='center'><tr><td width='60'>".$row["Rut_Operador"]."</td><td width='120'>".$row["Nombre_Operador"]."</td><td width='60'>".$row["Fono_Contacto"]."</td><td width='220'>".$row["Direccion_Operador"]."</td><td width='100'>".$row["Ano"]."-".$row["Mes"]."-".$row["Dia"]."</td><td width='70'>".$row["Cargo_Operador"]."</td><td width='70'>".$row["Licencia"]."</td></tr></table>";
		}
	//}
