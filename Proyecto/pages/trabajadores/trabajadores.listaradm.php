...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Listar Registros de Trabajadores</h3>
                 <p align="justify">Esta opción permite mostrar un listado de los trabajadores de la empresa. Aquí sólo se mostrarán los Trabajadores que sean Choferes y que tengan a cargo un Camión.<br><br> Además se puede contemplar la fecha de la última modificación que se le hizo al registro, como también el usuario que la hizo.</p>      
