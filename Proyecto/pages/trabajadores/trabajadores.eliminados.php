	...
	<!-- modal content -->
		<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Registro de Trabajadores que han Sido Eliminados</h3>
...
<font size="1">
    <h2>Lista de  Trabajadores Eliminados</h2>
  <?php
	include("conecta.php");
	$conexion=Conectarse();
  ...
  <tr><td width='60'>RUT</td><td width='120'>NOMBRE</td><td width='65'>TELEFONO</td><td width='70'>CARGO</td><td width='220'>MOTIVO</td><td width='75'>F. ELIMINADO</td><td width='70'>USUARIO</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from n_operador where Estado='DESPEDIDO' and Cargo_Operador='Chofer'";
