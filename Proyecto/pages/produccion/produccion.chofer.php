...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Resumen de Producción Mensual por Chofer</h3>
                 <p align="justify">Esta opción nos permite ver la Producción hecha en el Mes por un chofer a selección. Sólo debe seleccionar el Mes, el Año y la Patente del Camión, y podrá revisar detalladamente las ganancias del Mes seleccionado.<br></p>      
...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Resumen de Transportes por Chofer</strong></h3>
    <div id="tira">
    <table width="451" border="0">
      ...
      <script>document.form1.mes.focus()</script>
        <td width="74"><select name="ano" id="ano">
		...
		$conexion=Conectarse();
          ...
          $result=mysql_query("select * from guia_camion");
	...
	echo "<b><font color='#000'><h4><div align='left'>Guías Registradas del Camión Patente $patente en $mes del Año $ano</div></h4></font></b> ";
	echo "<hr>";
  ...
  <tr><td width='70'>FECHA</td><td width='50'>PATENTE</td><td width='70'>N° GUÍA</td><td width='100'>ORIGEN</td><td width='120'>DESTINO</td><td width='70'>DESPACHO</td><td width='60'>CANT. M3</td><td width='60'>TARIFA</td><td width='80'>MONTO DESP.</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select a.Id, a.Patente_Ca, a.Nombre_Tra, b.Id, b.N_Guia_pro, b.Dia, b.Mes, b.Ano, b.Origen, b.Destino, b.N_Despacho, b.Cantidad_m3, b.Tarifa, b.Monto_Despacho, b.Fecha_Ingreso from guia_camion a, guia b where a.Patente_Ca=".$_POST[camion]." and b.Mes=".$_POST[mes]." and b.Ano=".$_POST[ano]." and a.Id=b.Id order by b.Origen and b.Fecha_Ingreso asc";
...
?>
    ...
    <hr>
<?
	$sql="select a.Patente_Ca, sum(b.Monto_Despacho), sum(b.Cantidad_m3),b.Dia , b.Mes from guia_camion a, guia b where b.Mes=".$_POST[mes]." and b.Ano=".$_POST[ano]." and a.Patente_Ca=".$_POST[camion];
		$respuesta=mysql_query($sql,$conexion);
