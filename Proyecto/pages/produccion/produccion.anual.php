...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Resumen de Producción Anual</h3>
                 <p align="justify">Esta opción nos permite ver la Producción hecha en el Año. Sólo debe seleccionar el Año, y podrá revisar detalladamente las ganancias del Año seleccionado.<br></p>      
...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Resumen de Transportes Anual</strong>    </h3>
    <div id="tira">
    <table width="268" border="0">
      <tr>
        <td width="95"><h4>Seleccione Año</h4></td>
  ...
  <option selected="selected">2010</option>
	...
	echo "<b><font color='#000'><h4><div align='left'>Guías Registradas en el Año $ano</div></h4></font></b> ";
	echo "<hr>";
  ...
  <tr><td width='70'>FECHA</td><td width='50'>PATENTE</td><td width='70'>N° GUÍA</td><td width='100'>ORIGEN</td><td width='120'>DESTINO</td><td width='70'>DESPACHO</td><td width='60'>CANT. M3</td><td width='60'>TARIFA</td><td width='80'>MONTO DESP.</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select a.Id, a.N_Guia_pro, a.Patente_Ca, a.Nombre_Tra, b.Id, b.N_Guia_pro, b.Dia, b.Mes, b.Ano, b.Origen, b.Destino, b.N_Despacho, b.Cantidad_m3, b.Tarifa, b.Monto_Despacho, b.Fecha_Ingreso from guia_camion a, guia b where b.Ano=".$_POST[ano]." and a.Id=b.Id and a.N_Guia_pro=b.N_Guia_pro order by b.Fecha_Ingreso asc";
...
?>
    ...
    <hr>
<?
	$sql="select sum(Monto_Despacho), sum(Cantidad_m3) from guia where Ano=".$_POST[ano];
		$respuesta=mysql_query($sql,$conexion);
