...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Resumen de Producción Mensual</h3>
                 <p align="justify">Esta opción nos permite ver la Producción hecha en el Mes. Sólo debe seleccionar el Mes y el Año, y podrá revisar detalladamente las ganancias del Mes seleccionado.<br></p>      
...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Resumen de Transportes por Mes</strong>    </h3>
    <div id="tira">
...
<option selected="selected">2010</option>
  ...
  <tr><td width='70'>FECHA</td><td width='50'>PATENTE</td><td width='70'>N° GUÍA</td><td width='100'>ORIGEN</td><td width='120'>DESTINO</td><td width='70'>DESPACHO</td><td width='60'>CANT. M3</td><td width='60'>TARIFA</td><td width='80'>MONTO DESP.</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select a.Id, a.N_Guia_pro, a.Patente_Ca, a.Nombre_Tra, b.Id, b.N_Guia_pro, b.Dia, b.Mes, b.Ano, b.Origen, b.Destino, b.N_Despacho, b.Cantidad_m3, b.Tarifa, b.Monto_Despacho, b.Fecha_Ingreso from guia_camion a, guia b where b.Mes=".$_POST[mes]." and b.Ano=".$_POST[ano]." and a.Id=b.Id and a.N_Guia_pro=b.N_Guia_pro order by b.Fecha_Ingreso and a.Patente_Ca and b.Origen asc";
...
?>
    ...
    <hr>
<?
	$sql="select sum(Monto_Despacho), sum(Cantidad_m3) from guia where Mes=".$_POST[mes]." and Ano=".$_POST[ano];
		$respuesta=mysql_query($sql,$conexion);
