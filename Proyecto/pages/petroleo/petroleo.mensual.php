	...
	<!-- modal content -->
		<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Informe de Petroleo Gastado Mensual</h3>
                 <p align="justify">Esta opción nos permite ver un informe mensual de las guía de petróleo ingresadas al sistema.</p>
            	<br>
                <p align="justify">Para esto solo seleccionamos el mes y el año y presionamos el botón   			  				<b>"Buscar"</b>. Luego de esto el sistema nos arroja las guías ingresadas en la fecha seleccionada.</p>
                <br>
...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Gasto Mensual Petróleo</strong></h3>
    <div id="tira">
...
<option selected="selected">2010</option>
	...
	echo "<b><font color='#000'><h4><div align='left'>Gasto de Petróleo de $mes del Año $ano</div></h4></font></b> ";
	echo "<hr>";
  ...
  <tr><td width='70'>FECHA</td><td width='60'>N° GUIA</td><td width='60'>RETIRÓ</td><td width='65'>F. a PAGAR</td><td width='60'>ESTADO</td><td width='60'>CANTIDAD</td><td width='145'>DETALLE</td><td width='70'>V. UNITARIO</td><td width='60'>TOTAL</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from petroleo where Mes=".$_POST[mes]." and Ano=".$_POST[ano]." order by Fecha asc";
		$respuesta=mysql_query($sql,$conexion);
		
		if (mysql_num_rows($respuesta) == 0) {
   			echo '<script>alert("No existe gasto de Petróleo este Mes.");</script>';
    	exit;
		}else{
...
?>
    ...
    <hr>
<?
	$sql="select sum(Valor_Total) from petroleo where Mes=".$_POST[mes];
		$respuesta=mysql_query($sql,$conexion);
		
		while($row=mysql_fetch_array($respuesta)){
			
		echo "<div align='right'><h4>Total Gasto Petróleo en el Mes  =  $  ".$row['sum(Valor_Total)']."</h4></div>";
