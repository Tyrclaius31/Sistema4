...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Listar Registros de Guías Anual</h3>
                 <p align="justify">Esta opción permite mostrar un listado de las Guías ingresadas al sistema. Sólo hay que seleccionar el Año, y se desplegará el informe de las Guías ingresadas en el año selecionado.<br></p>      
...
<div id="contenedorgeneral">
 ...
 <form id="form1" name="form1" method="post" action="">
  <div align="center">
    <h3><strong>Lista de Guías Anual</strong></h3>
    <div id="tira">
    <table width="250" border="0">
      <tr>
        <td width="105"><h4>Seleccione Año </h4></td>
...
<option>2010</option>
  ...
  <tr><td width='70'>FECHA</td><td width='70'>N° GUÍA</td><td width='120'>ORIGEN</td><td width='120'>DESTINO</td><td width='70'>DESPACHO</td><td width='70'>CANT. M3</td><td width='70'>TARIFA</td><td width='80'>MONTO DESP.</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from guia where Ano=".$_POST[ano]." order by Fecha_Ingreso asc";
...
?>
    ...
    <hr>
<?
	$sql="select sum(Monto_Despacho) from guia where Ano=".$_POST[ano];
		$respuesta=mysql_query($sql,$conexion);
		
		while($row=mysql_fetch_array($respuesta)){
			
		echo "<div align='right'><h4>Total Calculado en Guías de Despacho en el Año $ano  =  $  ".$row['sum(Monto_Despacho)']."</h4></div>";
