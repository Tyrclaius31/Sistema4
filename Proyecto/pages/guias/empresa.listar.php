...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Listar Registros de Empresas</h3>
                 <p align="justify">Esta opción nos permite mostrar la lista de Empresas registradas en el sistema.<br></p>      
...
<p><font size="1">
  ...
  <tr><td width='50'>RUT</td><td width='80'>NOMBRE EMP.</td><td width='150'>DUEÑO</td><td width='200'>DIRECCION</td><td width='60'>TELEFONO</td><td width='60'>FAX</td><td width='70'>F. INGRESO</td></tr></table></font></b>";
	echo "<hr>";
		$sql="select * from empresas";
		$respuesta=mysql_query($sql,$conexion);
		while($row=mysql_fetch_array($respuesta))
		{
			echo "<table width='670' border='0' align='center'><tr><td width='50'>".$row["Rut_Empresa"]."</td><td width='80'>".$row["Nombre_Empresa"]."</td><td width='150'>".$row["Nombre_Dueno"]."</td><td width='200'>".$row["Direccion"]."</td><td width='60'>".$row["Telefono"]."</td><td width='60'>".$row["Fax"]."</td><td width='70'>".$row["Fecha_Ingreso"]."</td></tr></table>";
		}
	//}
