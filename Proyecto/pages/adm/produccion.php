...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Estadísticas Anual de Producción</h3>
                 <p align="justify">Esta opción permite mostrar las estadísticas del año. En primera instancia muestra un gráfico de barras, en el cuál se puede ver lo ganado durante el año seleccionado. Como segunda opción se despliega un gráfico circular, en el cual se puede observar en porcentajes lo detallado en el gráfico anterior.<br></p>      
...
<div id="contenedorgeneralll">
  ...
  <div align="center">
    <h3><strong>Estadísticas Anual de Producción</strong></h3>
    <div id="tira">
	...
	{
		$sql="select sum(Monto_Despacho) from guia where Mes ='01' and Ano=".$_POST[ano];
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='02' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='03' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='04' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='05' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='06' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='07' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='08' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='09' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='10' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='11' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Monto_Despacho) from guia where Mes ='12' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$strXML = "";
		$strXML = "<chart caption = 'Grafico Anual de PRODUCCIÓN' bgColor='#FFFFFF' yAxisName='Nivel en Pesos' numberPrefix='$' 		        formatNumberScale='0' baseFontSize='9' showValues='1' xAxisName='Meses' decimals='1' enableSlicingMovement='1'
