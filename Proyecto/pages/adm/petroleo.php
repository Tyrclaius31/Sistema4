...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Estadísticas Anual de Gasto de Petróleo</h3>
                 <p align="justify">Esta opción permite mostrar las estadísticas del año en cuanto al Gasto de Petróleo realizado. En primera instancia muestra un gráfico de barras, en el cuál se puede ver lo que se gastó durante el año seleccionado. Como segunda opción se despliega un gráfico circular, en el cual se puede observar en porcentajes lo detallado en el gráfico anterior.<br></p>      
...
<div id="contenedorgeneralll">
  ...
  <div align="center">
    <h3><strong>Estadísticas Anual del Gasto de Petróleo</strong></h3>
    <div id="tira">
	...
	{
		$sql="select sum(Valor_Total) from petroleo where Mes ='01' and Ano=".$_POST[ano];
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='02' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='03' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='04' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='05' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='06' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='07' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='08' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='09' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='10' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='11' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$sql="select sum(Valor_Total) from petroleo where Mes ='12' and Ano=".$_POST[ano];
				$respuesta=mysql_query($sql,$conexion);
				if(mysql_affected_rows()>0)
				{
					$registro=mysql_fetch_row($respuesta);
		...
		$strXML = "";
		$strXML = "<chart caption = 'Grafico Gasto PETRÓLEO' bgColor='#FFFFFF' yAxisName='Nivel en Pesos' numberPrefix='$' 		        formatNumberScale='0' baseFontSize='9' showValues='1' xAxisName='Meses' decimals='1' enableSlicingMovement='1'
