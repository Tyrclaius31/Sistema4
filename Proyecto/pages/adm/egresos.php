...
<div id="osx-modal-content">
			...
			<div id="osx-modal-data">
				<h3>Estadísticas Anual de Egresos</h3>
                 <p align="justify">Esta opción permite mostrar las estadísticas del año en cuanto a los egresos realizados. En primera instancia muestra un gráfico de barras, en el cuál se puede ver lo que se gastó durante el año seleccionado. Como segunda opción se despliega un gráfico circular, en el cual se puede observar en porcentajes lo detallado en el gráfico anterior.<br></p>      
...
<div id="contenedorgeneralll">
  ...
  <div align="center">
    <h3><strong>Estadísticas Anual de Gastos</strong></h3>
    <div id="tira">
