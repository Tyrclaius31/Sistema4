  ...
  <div id="cuerpoleft">
    <div id="manulateral">
     ...
     <h3><center>Egresos s/iva</center></h3>
      <ul>
        <li><a href="pages/pago/egresos.registro.php" title="Registrar Nuevo Egreso">- Reg. Egresos $$</a></li>
        <?php if($_SESSION['Cargo']=='SECRETARIA' or $_SESSION['Cargo']=='Secretaria' or $_SESSION['Cargo']=='secretaria'){  ?>
        <li><a href="pages/pago/egresos.listar.php" title="Listar Datos de Egresos Mensual">- Listar Registro</a></li>
        <?php } 
       	if($_SESSION['Cargo']=='SUPERVISOR' or $_SESSION['Cargo']=='ADMINISTRADOR'){  ?>
        <li><a href="pages/pago/egresos.modificar.php" title="Modificar Registros">- Mod. Registro</a></li>
        <li><a href="pages/pago/egresos.listaradm.php" title="Listar Datos de Egresos Mensual">- Listar Registro</a></li>
		<?php } ?>
        <li><a href="pages/pago/egresos.listar.anual.php" title="Listar Datos de Egresos Anuales">- Registro Anual</a></li>
        <li><a href="#" title="">______________</a></li>
      </ul>
      
       <h3><center>Egresos c/iva</center></h3>
      <ul>
        <li><a href="pages/pago/egresos.registro.iva.php" title="Registrar Nuevo Egreso">- Reg. Egresos $$</a></li>
        <?php if($_SESSION['Cargo']=='SECRETARIA' or $_SESSION['Cargo']=='Secretaria' or $_SESSION['Cargo']=='secretaria'){  ?>
        <li><a href="pages/pago/egresos.listar.iva.php" title="Listar Datos de Egresos Mensual">- Listar Registro</a></li>
        <?php } 
       	if($_SESSION['Cargo']=='SUPERVISOR' or $_SESSION['Cargo']=='ADMINISTRADOR'){  ?>
        <li><a href="pages/pago/egresos.modificar.iva.php" title="Modificar Registros">- Mod. Registro</a></li>
        <li><a href="pages/pago/egresos.listaradm.iva.php" title="Listar Datos de Egresos Mensual">- Listar Registro</a></li>
		<?php } ?>
        <li><a href="pages/pago/egresos.listar.anual.iva.php" title="Listar Datos de Egresos Anuales">- Registro Anual</a></li>
        <li><a href="#" title="">______________</a></li>
        <li><a href="pages/pago/egresos.petroleo.php" title="Pagar Petróleo">- Pagar Petróleo</a></li>
        <li><a href="pages/pago/egresos.iva.php" title="Pagar IVA">- Pagar IVA</a></li>
      </ul>
